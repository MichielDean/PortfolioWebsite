...
description: Work with Michiel's PortfolioWebsite repo — portfolio site. Use when: working on the portfolio site code. Triggers on: "PortfolioWebsite".
...
## Michiel's Work History (for context)
