...
export const profileData: Profile = {
  ...
  skills: [
    ...
    "Roadmap Planning",
    "Cloud Networking (VPC, Load Balancers, DNS, Service Discovery)",
    "Claude Code",
    "Cursor",
  ...
  skillCategories: [
    { category: "Leadership & Strategy", skills: ["Engineering Leadership", "Agile/Scrum", "Cross-functional Collaboration", "Mentorship", "Strategic Planning", "Hiring & Interviewing", "Performance Management", "Roadmap Planning", "Architecture Decision Records"] },
    ...
    { category: "Cloud & DevOps", skills: ["AWS", "Azure", "GCP", "CI/CD", "Jenkins", "TeamCity", "GitHub Actions", "GitLab CI", "GitOps", "ArgoCD", "Kubernetes", "Docker", "Terraform", "Artifactory/Nexus", "Pipeline as Code", "Cloud Networking (VPC, Load Balancers, DNS, Service Discovery)", "Linux Systems"] },
    ...
    { category: "Observability & Reliability", skills: ["Datadog", "Grafana/Prometheus", "New Relic", "ELK/Splunk", "DORA Metrics", "Developer Productivity", "Incident Response", "On-Call/SLOs"] },
    ...
    { category: "Compliance", skills: ["SOC 3 Compliance"] },
    ...
    { category: "Domain Expertise", skills: ["Digital Media/Streaming", "Ad Tech", "Cloud Infrastructure/Platform"] },
  ],
