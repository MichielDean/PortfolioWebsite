...
export class RpsEmploymentData implements IEmploymentData {
  ...
  details: string[] = [
    ...
    `Drastically increased the quality of the websites that we offer by pushing testing into the entire delivery process. This also increased time to production four our projects and made production deployments less frightening to the team.`,
