...
export class JelliEmploymentData implements IEmploymentData {
  ...
  details: string[] = [
    ...
    `I still have passion for writing code and test architecture, so I have been authoring mostly framework level code to help my team work more efficiently.`,
